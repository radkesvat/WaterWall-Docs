...
TrojanClient, TrojanServer and VlessClient also use a **2 MiB logical-byte base
...
| --- | --- |
| Protocol/order/replay or output backlog in these three nodes | 2,097,152 bytes; 1,024 output/backlog entries |
