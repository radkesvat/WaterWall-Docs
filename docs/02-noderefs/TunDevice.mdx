...
Sync note: Any change to this file must also be applied to WaterWall/tunnels/TunDevice/description.md and WaterWall-Docs/i18n/fa/docusaurus-plugin-content-docs/current/02-noderefs/TunDevice.mdx, and all files must keep the same documentation version.
-->
...
[Windows recovery contract](https://github.com/radkesvat/WaterWall/blob/main/core/tools/windows_launcher/LIFECYCLE.md#what-remains-after-forced-termination)
...
See the [restart flow](https://github.com/radkesvat/WaterWall/blob/main/core/tools/windows_launcher/LIFECYCLE.md#restart-after-a-crash).
