...
Static listener retirement closes admission before notifying peer-owner workers. A canceled notification leaves the existing finite idle deadline and shutdown drain responsible; retired traffic cannot refresh or create peers. Dynamic endpoints detach their handle, WIO and owned line together.
