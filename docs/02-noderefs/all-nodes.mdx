...
| `ConnectionToPackets` | Opens a connection line as a userspace lwIP TCP/UDP flow and emits raw IPv4 packets. | Stream-to-packet bridge, after a listener or `Socks5Server`. |
