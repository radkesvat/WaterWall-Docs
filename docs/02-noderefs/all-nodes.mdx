...
| `HeaderClient` | Prepends a one-time WaterWall port header or IPv4 PROXY protocol header. | Paired with `HeaderServer` for WaterWall headers, or before a PROXY-aware backend. |
