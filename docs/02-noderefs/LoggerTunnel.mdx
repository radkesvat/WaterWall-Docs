...
Sync note: Any change to this file must also be applied to WaterWall/tunnels/logger/description.md, and both files must keep the same documentation version.
-->
...
| Property | Value |
|---|---|
| Position | Middle-only (`kNodeFlagNone`) |
...
| File prefix | Node `name`, or `LoggerTunnel` if empty |
