...
description: "Reference documentation for the TcpUdpConnector node."
---

<!--
Documentation version: 152
Sync note: Any change to this file must also be applied to WaterWall/tunnels/TcpUdpConnector/description.md and WaterWall-Docs/i18n/fa/docusaurus-plugin-content-docs/current/02-noderefs/TcpUdpConnector.mdx, and all files must keep the same documentation version.
-->
