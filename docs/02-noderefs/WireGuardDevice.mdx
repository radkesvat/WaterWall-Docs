...
Sync note: Any change to this file must also be applied to WaterWall/tunnels/WireGuardDevice/description.md, and both files must keep the same documentation version.
-->
...
| Property | Value |
|---|---|
| Runtime model | Pure packet tunnel plus owned companion transport lines |
| Per-line packet state | none |
