...
`L` is the current line pool large payload capacity. The limit is 131,070 bytes
at 32 KiB and 2,097,120 bytes at 512 KiB. It applies to initial publication and
