...
Here `L` is the current line pool large payload capacity. The limit is 65,535
bytes at 32 KiB and 1,048,560 bytes at 512 KiB. Validate the handshake and try
