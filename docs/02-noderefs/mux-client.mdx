...
| `connection-duration` | فقط در `timer` | مدت پذیرش child جدید روی هر parent، به میلی‌ثانیه. باید بزرگ‌تر از `60` باشد. |
...
|---|---|---|
| `timer` | وقتی parent فعلی از `connection-duration` پیرتر شود | پخش اتصال‌ها در طول زمان و جلوگیری از خیلی بزرگ شدن parentهای قدیمی |
