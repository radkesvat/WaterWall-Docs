...
title: "HttpProxyClient"
sidebar_label: "HttpProxyClient"
description: "HTTP/1.1 CONNECT tunnels and single HTTP requests through an upstream proxy, with optional Basic authentication and splice support."
---
