...
header یک‌باره فقط در padding واقعی و اعلام‌شدهٔ سمت چپ، پیش از prefix موجود نوشته می‌شود. بدنهٔ داده در pipe خصوصی می‌ماند و payloadهای بعدی upstream و همهٔ payloadهای downstream بدون تغییر عبور می‌کنند. پشتیبانی HeaderClient به معنی پشتیبانی HeaderServer نیست؛ زنجیره‌ای که HeaderServer دارد همچنان از بافر عادی استفاده می‌کند.
