...
در حالت TCP مذاکره‌شده، payload بزرگ به فریم‌های متوالی با حداکثر ۶۵۵۰۵ بایت
تقسیم می‌شود و همهٔ فریم‌های encodeشده در یک callback تحویل داده می‌شوند. ترتیب
بایت‌های TCP حفظ می‌شود. در حالت UDP هر payload یک datagram است و datagram
بزرگ‌تر از حد مجاز همچنان drop می‌شود؛ برای جا دادن آن نباید datagram را تقسیم کرد.
