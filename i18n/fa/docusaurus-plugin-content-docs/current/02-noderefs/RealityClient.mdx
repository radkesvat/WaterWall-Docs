...
- فرمت native-sized در Reality v2 جای layout منتشرنشده قبلی با prefix دوازده‌بایتی را می‌گیرد. هر دو peer را هم‌زمان ارتقا دهید؛ fallback به v1 یا layout قدیمی وجود ندارد و setting منسوخ `max-frame-size` در startup رد می‌شود.
