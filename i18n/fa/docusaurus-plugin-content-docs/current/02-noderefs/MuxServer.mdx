...
| `parent-buffer-limit` | integer | `33554432` | سقف بودجه داده‌های صف‌شده برای childها به‌ازای هر parent. با رسیدن به سقف، child با بیشترین صف بسته می‌شود؛ در صورت مساوی بودن، اولویت با قدیمی‌ترین child متصل است. برای غیرفعال کردن سقف تجمیعی مقدار `0` را قرار دهید. |
...
- اگر مجموع داده‌های صف‌شده child به `parent-buffer-limit` برسد، child با بیشترین صف بسته می‌شود. در صورت مساوی بودن، اولویت با قدیمی‌ترین child متصل است.
