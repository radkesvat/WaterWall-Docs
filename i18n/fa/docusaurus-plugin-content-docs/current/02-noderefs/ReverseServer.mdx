...
`L` مبنای مستقل بودجهٔ انتظار در pool خط است: ۶۴ KiB در S1/S2 و ۱ MiB در پروفایل‌های بالاتر. این مبنا از اندازهٔ بافرهای عادی و سقف splice مستقل است. حد انتظار در S1/S2 برابر ۱۳۱۰۷۰ و در پروفایل‌های بالاتر برابر ۲۰۹۷۱۲۰ بایت است؛ فقط عبور از حد موجب بستن می‌شود. اعتبارسنجی handshake و جفت‌شدن با همتای حاضر پیش از بررسی حد انتظار انجام می‌شوند.
