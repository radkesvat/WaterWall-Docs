...
`L` ظرفیت بافر بزرگ pool همان خط است. حد انتظار در ۳۲ KiB برابر ۶۵۵۳۵ و در ۵۱۲ KiB برابر ۱۰۴۸۵۶۰ بایت است؛ فقط عبور از حد موجب بستن می‌شود. اعتبارسنجی handshake و جفت‌شدن با همتای حاضر پیش از بررسی حد انتظار انجام می‌شوند.
