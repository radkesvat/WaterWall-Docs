...
این قاعده فرض مالکیت نودهای عادی stream را حفظ می‌کند. downstream Init از
ReverseClient مستقیماً به Bridge می‌رسد و در شاخهٔ جفت‌شده به upstream Init
تبدیل می‌شود. Bridge همان line را عبور می‌دهد و مالک آن نمی‌شود. تغییر جهت باید
در همین مرز بماند؛ نود میانی‌ای که مالک line را در سمت `prev` فرض می‌کند نباید
در این فاصله قرار بگیرد.
...
در هر دو جهت معتبر، همان بافر و همان line با نگاشت فعلی جهت callback از Bridge جفت عبور می‌کنند. کل توپولوژی ادغام‌شده باید واجد شرایط باشد. Bridge مالک line عبوری نمی‌شود.
