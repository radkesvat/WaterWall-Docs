...
داده‌های مجاز و مدیریت‌نشده در هر دو جهت بدون بررسی بدنه عبور می‌کنند. حسابداری ترافیک بر اساس طول منطقی payload، شامل prefix مقیم حافظه، انجام می‌شود؛ نگاشت معکوس upload/download برای line آغازشده از next حفظ می‌شود. هنگام رد ترافیک، بافر هنوز تحت مالکیت نود بازیافت و دادهٔ pipe خصوصی تخلیه می‌شود، سپس مسیر فعلی بستن line اجرا می‌شود.
