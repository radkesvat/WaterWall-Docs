...
`TesterServer` معمولاً در انتهای chain قرار می‌گیرد. در packet mode می‌تواند `next` هم داشته باشد تا مسیرهای bridged packet از سمت next/downstream به آن داده برسانند.
