...
`L` ظرفیت بافر بزرگ pool خط است. حد انتظار در ۳۲ KiB برابر ۱۳۱۰۷۰ و در ۵۱۲ KiB برابر ۲۰۹۷۱۲۰ بایت است. رسیدن به حد یا عبور از آن، هم برای ورودی نخست و هم افزودن بعدی، موجب بستن می‌شود؛ دادهٔ جفت‌شده مستقیم عبور می‌کند.
