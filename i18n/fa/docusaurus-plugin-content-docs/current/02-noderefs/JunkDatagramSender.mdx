...
دادهٔ junk تولیدشده و نسخه‌های تأخیری آن همچنان بافر عادی هستند. payload برنامه بدون بررسی بدنه عبور می‌کند و بدنهٔ pipe خصوصی و ترتیب فعلی نسبت به junk فوری حفظ می‌شود. جهت بسته‌شده ورودی را دور می‌ریزد؛ اگر ارسال junk خط را ببندد، بافر برنامه که هنوز تحت مالکیت نود است بازیافت می‌شود.
